...
export async function addPresentation(prevState: ActionStateType, formData: FormData): Promise<ActionStateType> {
    ...
    return { errors: [], success: "Presentación agregada correctamente" }
}
