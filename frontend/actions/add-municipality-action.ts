...
export async function addMunicipality(prevState: ActionStateType, formData: FormData): Promise<ActionStateType> {
    ...
    return { errors: [], success: "Municipio agregado correctamente" }
}
