...
import { updateMunicipality } from "@/actions/update-municipality-action"
import { toast } from "react-toastify"
import { useParams, useRouter } from "next/navigation"

export default function EditMunicipalityForm({ children }: { children: React.ReactNode }) {
    const router = useRouter()
    const { id } = useParams<{ id: string }>()

    const updateWithId = updateMunicipality.bind(null, +id)
